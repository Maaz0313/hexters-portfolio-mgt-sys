...
import { FaPalette, FaPlug, FaChartLine, FaGlobe, FaShopify } from "react-icons/fa";
...
const Shopify = () => {
  ...
  return (
    <>
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-950 to-blue-700 py-32">
          ...
          >
            <div className="mb-8 flex justify-center">
              <div className="relative">
                <FaShopify className="text-7xl text-[#95BF47]" />
              </div>
            </div>
        ...
        {/* Decorative elements */}
        <motion.div
          className="absolute bottom-10 left-10 h-20 w-20 rounded-full bg-blue-400/20"
          animate={{ y: [0, -15, 0] }}
          transition={{ repeat: Infinity, duration: 2 }}
        />
        <motion.div
          className="absolute top-20 right-20 h-12 w-12 rounded-full bg-blue-300/20"
          animate={{ y: [0, -10, 0] }}
      ...
      <section className="bg-blue-100 py-20">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <motion.a
              href="/contact"
              className="inline-flex h-[56px] w-fit items-center justify-center rounded-[80px] border-none bg-blue-600 px-8 font-medium text-white shadow-[0_6px_12px_rgba(0,0,0,0.3),0_1px_2px_rgba(0,0,0,0.3)] transition-all duration-300 hover:bg-blue-700 hover:shadow-[0_10px_24px_rgba(0,0,0,0.3),0_6px_12px_rgba(0,0,0,0.3)]"
