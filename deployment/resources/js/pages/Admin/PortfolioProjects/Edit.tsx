...
const Edit = ({ portfolioProject, brandings, industries }: Props) => {
  ...
  const { data, setData, post, processing, errors } = useForm({
    ...
    completion_date: portfolioProject.completion_date || '',
    is_featured: portfolioProject.is_featured,
    is_published: portfolioProject.is_published,
  });

  const [previewUrl, setPreviewUrl] = useState<string | null>(
    portfolioProject.image ? `/storage/${portfolioProject.image}` : null
  );
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="mt-1 flex items-center">
                        ...
                        >
                          {portfolioProject.image ? 'Change Image' : 'Select Image'}
                        </label>
                      </div>
                      {previewUrl && (
                        <div className="mt-2">
