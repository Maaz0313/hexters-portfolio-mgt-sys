...
const Footer = () => {
    return (
        <section className="bg-[#0a2550] px-0 py-16 text-sm/[1.375] md:text-base/normal">
            <div className="container">
                ...
                <div className="grid grid-flow-row max-[1219px]:[row-gap:32px] md:grid-cols-[repeat(12,1fr)] lg:[grid-column-gap:24px]">
                    <div className="col-[span_6] md:col-[span_4]">
                        <div>
                            <div className="mb-4 text-sm leading-tight font-semibold text-white md:text-base">Follow</div>
                            <div className="space-y-2">
                                <div>
                                    <a
                                        className="flex items-center text-white underline decoration-[color:var(--color-foreground)] decoration-2 underline-offset-4 outline-hidden transition-[text-decoration-color] delay-0 duration-[.4s] ease-[ease] hover:decoration-transparent hover:transition-[text-decoration-color] hover:delay-0 hover:duration-[.2s] hover:ease-[ease]"
                                        href="https://www.facebook.com/profile.php?id=61561499371019"
                                    >
                                        <div className="mr-2 size-4 text-white">
                                ...
                                <div>
                                    ...
                                    >
                                        <div className="mr-2 size-4 text-white">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300.251" fill="currentColor">
                    ...
                    <div className="col-[span_6] md:col-[span_4]">
                        <div>
                            <div className="mb-4 text-sm leading-tight font-semibold text-white md:text-base">Contact Us</div>
                            <div className="space-y-2">
                                <div>
                                    <a
                                        className="flex items-center text-white underline decoration-[color:var(--color-foreground)] decoration-2 underline-offset-4 outline-hidden transition-[text-decoration-color] delay-0 duration-[.4s] ease-[ease] hover:decoration-transparent hover:transition-[text-decoration-color] hover:delay-0 hover:duration-[.2s] hover:ease-[ease]"
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <span>hexters2010@gmail.com</span>
                                    </a>
                                </div>
                                <div>
                                    <Link
                                        className="flex items-center text-white underline decoration-[color:var(--color-foreground)] decoration-2 underline-offset-4 outline-hidden transition-[text-decoration-color] delay-0 duration-[.4s] ease-[ease] hover:decoration-transparent hover:transition-[text-decoration-color] hover:delay-0 hover:duration-[.2s] hover:ease-[ease]"
                                        href={route('our-locations')}
                                    >
                                        <div className="mr-2 size-4 text-white">
                                            <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                    ...
                    <div className="col-[span_6] md:col-[span_4]">
                        <div>
                            <div className="mb-4 text-sm leading-tight font-semibold text-white md:text-base">Stay informed</div>
                            <div className="space-y-2">
                                <div className="text-white">Our best articles, observations and news delivered to your inbox</div>
                                <Link
                                    className="mt-4 inline-flex items-center gap-3 rounded-[80px] border-none bg-white px-6 py-4 text-sm/[1.375] font-medium text-[#0a2550] shadow-[0_6px_12px_rgba(0,0,0,0.3),0_1px_2px_rgba(0,0,0,0.3)] transition-all duration-300 ease-[ease-in-out] hover:bg-[#4ecdc4] hover:text-[#0a2550] hover:shadow-[0_10px_24px_rgba(0,0,0,0.3),0_6px_12px_rgba(0,0,0,0.3)] md:text-base/normal"
                ...
                <div className="mt-16 border-t border-t-[color:var(--color-foreground)] pt-8">
                    <div className="-mx-3 flex flex-wrap text-white">
                        ...
                        <div className="order-1 flex w-full flex-wrap justify-center space-x-8 px-3 py-0">
                            <div>
                                <Link
                                    className="text-white underline decoration-[color:var(--color-foreground)] decoration-2 underline-offset-4 outline-hidden transition-[text-decoration-color] delay-0 duration-[.4s] ease-[ease] hover:decoration-transparent hover:transition-[text-decoration-color] hover:delay-0 hover:duration-[.2s] hover:ease-[ease]"
