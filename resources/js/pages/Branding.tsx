...
function Branding() {
  ...
  return (
    <PortfolioLayout title="Branding Services">
      ...
      <section className="relative bg-gradient-to-br from-primary to-accent py-32 text-white overflow-hidden">
        <div className="container mx-auto px-8">
          <div className="flex flex-col md:flex-row items-center">
            ...
            >
              ...
              <motion.a
                href="/contact"
                className="font-medium py-4 px-8 rounded-full text-lg shadow-lg transition-all duration-300"
                style={{
            ...
            >
              <div className="relative z-10">
                ...
                />
                <motion.div
                  className="absolute -bottom-8 -left-8 w-32 h-32 bg-primary rounded-full opacity-60"
                  animate={{
                    scale: [1, 1.3, 1],
                  }}
        ...
        />
        <motion.div
          className="absolute bottom-0 left-0 w-80 h-80 bg-primary rounded-full opacity-20 blur-3xl"
          animate={{
            x: [0, -20, 0],
            y: [0, 20, 0],
          }}
      ...
      <section className="relative overflow-hidden py-24 bg-white">
        ...
        <div className="absolute bottom-0 left-0 h-64 w-64 rounded-full bg-accent/10 blur-3xl"></div>
        ...
        <div className="container relative z-10 mx-auto px-8">
          ...
          >
            <span className="mb-4 inline-block rounded-full bg-gradient-to-r from-accent to-primary px-4 py-1 text-sm font-medium text-white">Our Expertise</span>
            <h2 className="mb-6 text-4xl font-bold text-primary md:text-5xl">Branding Services That <span className="text-accent">Stand Out</span></h2>
          ...
          >
            {brandingServices.map((service, index) => (
              ...
              >
                <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-accent to-primary text-3xl text-white">
                  {service.icon}
                </div>
      ...
      <section className="bg-accent py-20">
        <div className="container mx-auto px-8">
          ...
          >
            ...
            <motion.a
              href="/contact"
              className="inline-block rounded-[80px] px-8 py-5 text-lg/[1.375] font-medium shadow-[0_6px_12px_rgba(0,0,0,0.3),0_1px_2px_rgba(0,0,0,0.3)] transition-all duration-300 hover:shadow-[0_10px_24px_rgba(0,0,0,0.3),0_6px_12px_rgba(0,0,0,0.3)]"
              style={{
                backgroundColor: "#1e3a6d",
                color: "white"
              }}
