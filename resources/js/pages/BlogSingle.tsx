        ...
        return (
            <PortfolioLayout title="Error">
                <div className="container mx-auto max-w-4xl px-4 py-8">
                    <div className="rounded border border-red-400 bg-red-100 px-4 py-3 text-red-700">Blog post not found</div>
                </div>
            </PortfolioLayout>
        );
    }
        ...
        <PortfolioLayout title={blogPost.title}>
            <div className="bg-background py-16 md:py-24">
                <div className="container mx-auto px-4 md:px-6">
                    {/* Breadcrumbs */}
                    <div className="text-foreground mb-8 text-sm">
                        <Link href={route('home')} className="hover:text-accent">
                            Home
                        </Link>
                        <span className="text-foreground mx-2">/</span>
                        <Link href={route('blogs')} className="hover:text-accent">
                            Blog
                        </Link>
                        <span className="text-foreground mx-2">/</span>
                    ...
                    {/* Post Header */}
                    <div className="mb-8">
                        <h1 className="mb-4 text-3xl font-bold text-gray-900 md:text-4xl lg:text-5xl">{blogPost.title}</h1>
                        ...
                        <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600">
                            ...
                            <div className="ml-auto flex items-center">
                                ...
                                <a
                                    href="#"
                                    className="bg-primary hover:bg-primary-dark mx-1 inline-flex h-8 w-8 items-center justify-center rounded-full text-white"
                                >
                                    <FaFacebookF />
                                </a>
                                <a
                    ...
                    <div className="mb-12 grid grid-cols-1 gap-8 lg:grid-cols-4">
                        ...
                        <div className="lg:col-span-1">
                            <div className="sticky top-24 rounded-xl bg-white p-6 shadow-sm">
                                <div className="mb-4 flex items-center">
                                    <div className="mr-4 flex h-16 w-16 items-center justify-center rounded-full bg-gray-200 text-gray-500">
                                ...
                                <p className="mb-4 text-sm text-gray-700">Author of this blog post.</p>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-3">
                            <div className="rounded-xl bg-white p-6 shadow-sm">
                                <div
                                    className="prose prose-lg prose-headings:text-gray-900 prose-p:text-gray-700 prose-a:text-primary prose-a:no-underline hover:prose-a:underline max-w-none"
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {blogPost.tags.map((tag) => (
                                                <Link
                                                    ...
                                                    className="hover:bg-primary rounded-full bg-gray-100 px-4 py-2 text-sm text-gray-700 hover:text-white"
                                                >
                                                    {tag.name}
                                                </Link>
                                            ))}
                        ...
                        <div className="mt-12">
                            ...
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                                {relatedPosts.map((relatedPost) => (
                                    <div
                                        key={relatedPost.id}
                                        className="overflow-hidden rounded-xl bg-white shadow-sm transition-transform hover:scale-105"
                                    >
