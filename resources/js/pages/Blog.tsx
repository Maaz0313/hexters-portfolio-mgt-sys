...
const Blog = ({
    ...
    const formatBlogPost = (post: BlogPost) => ({
        ...
        imageSrc: post.thumbnail_image
            ? `/storage/${post.thumbnail_image}`
            : post.featured_image
        ...
        <PortfolioLayout title="Blog">
            <section className="py-16 md:py-20">
                <div className="container flex flex-row justify-between">
                    ...
                    <a
                        className="inline-flex max-h-[55px] cursor-pointer items-center gap-3 self-end rounded-[80px] border-2 border-[#4ecdc4] bg-transparent px-4 py-2 text-base/[1.375] font-medium text-[#4ecdc4] shadow-[0_6px_12px_rgba(0,0,0,0.3),0_1px_2px_rgba(0,0,0,0.3)] transition-all duration-300 ease-[ease-in-out] hover:bg-[#4ecdc4] hover:text-[#0a2550] hover:shadow-[0_10px_24px_rgba(0,0,0,0.3),0_6px_12px_rgba(0,0,0,0.3)] max-md:mt-6 max-md:self-start"
                        href="/blogs#all-blogs"
                        onClick={scrollToAllBlogs}
                    >
                        <svg className="size-5 shrink-0" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <polygon
                                fill="currentColor"
                                fillRule="evenodd"
            ...
            <section className="py-16 md:py-20">
                <div className="container mb-12 flex justify-between max-lg:mb-8 max-lg:flex-col">
                    <h4 className="text-[34px]/[1.03] font-medium text-[#4ecdc4] md:text-[51px]/[1.04]">Latest posts</h4>
                    <div className="inline-flex items-center gap-1 max-lg:mt-6">
                        ...
                        <svg className="size-5 text-[#4ecdc4]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <polygon
                                fill="currentColor"
                                fillRule="evenodd"
            ...
            {topCategories.map((categoryName, index) => (
                <section key={index} className="py-16 md:py-20">
                    <div className="container mb-12 flex justify-between max-lg:mb-8 max-lg:flex-col">
                        <h4 className="text-[34px]/[1.03] font-medium text-[#4ecdc4] md:text-[51px]/[1.04]">{categoryName}</h4>
                        <div className="inline-flex items-center gap-1 max-lg:mt-6">
                            <a
                                href="#"
                                onClick={(e) => {
            ...
            <section ref={allBlogsRef} id="all-blogs" className="py-16 md:py-20">
                <div className="container mx-auto w-full max-w-[1220px] px-6 py-0">
                    <div className="mb-48 text-center">
                        ...
                        <p className="text-[1.1428571429rem]/[1.5] font-light text-white md:text-2xl/[1.375]">News and insights from our team.</p>
                    </div>
                ...
                <div className="container grid grid-cols-3 gap-6 max-md:grid-cols-1">
                    {blogPosts.data.length > 0 ? (
                        blogPosts.data.map((post) => <BlogPostCard key={post.id} {...formatBlogPost(post)} />)
                    ) : (
                ...
                {blogPosts.last_page > 1 && (
                    <Pagination currentPage={currentPage} totalPages={blogPosts.last_page} handlePageChange={handlePageChange} />
                )}
            </section>
        </PortfolioLayout>
    );
